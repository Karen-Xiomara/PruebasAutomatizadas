Feature: Modify the content of a post
  @user1 @web
  ...
  Then I enter "Esto es una modificacion" into input field having css selector ".koenig-editor__editor __mobiledoc-editor"
