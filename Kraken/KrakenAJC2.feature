  ...
  Feature: NEW a post Unpublished
  @user1 @web
  ...
  Then I enter "Esto es un Nuevo Post3 Unpublished" into input field having css selector ".gh-editor-title.ember-text-area.gh-input.ember-view"
  ...
  Then I click on element having css selector ".gh-btn.gh-btn-blue.gh-publishmenu-button.gh-btn-icon.gh-btn-green.ember-view"
  Then I wait for 5 seconds
