  ...
  Feature: Create a page schedule
  @user1 @web
  Scenario: As a first user I create a page schedule
  ...
  Then I enter "Pagina nueva programada" into input field having css selector ".gh-editor-title.ember-text-area.gh-input.ember-view"
  Then I enter "Descripcion de la pagina nueva programada" into input field having css selector ".koenig-editor__editor.__mobiledoc-editor.__has-no-content"
  ...
  Then I click on element having css selector ".gh-date-time-picker-timezone"
