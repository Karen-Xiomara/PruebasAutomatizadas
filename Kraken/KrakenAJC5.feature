  ...
  Feature: NEW a post Con Titulos y Sin Detalle
  @user1 @web
  ...
  Then I enter " " into input field having css selector ".koenig-editor__editor.__mobiledoc-editor.__has-no-content"
