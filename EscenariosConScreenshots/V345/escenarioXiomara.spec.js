describe('Create a page Schedule', () => {
    it('Create a page Schedule', () => {
      ...
      cy.wait(3000)  
      cy.screenshot('v345/Escenario11/escenario')
      cy.get('.gh-editor-title.ember-text-area.gh-input.ember-view').type('Pagina Schedule {enter}') 
      cy.screenshot('v345/Escenario11/escenario')
    })
    it('Create a page Schedule', () => {
      cy.visit('http://localhost:2369/ghost/#/signin')
      ...
      cy.wait(2000) 
      cy.screenshot('v345/Escenario11/escenario')
      cy.get('.koenig-editor__editor.__mobiledoc-editor.__has-no-content').type('Descripcion de la pagina nueva programada')
      cy.wait(5000)
      cy.screenshot('v345/Escenario11/escenario')
