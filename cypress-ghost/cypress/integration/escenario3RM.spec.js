import MOCK_DATA_PAGES from "../Mocks/MOCK_DATA_CREATE_PAGE_RM3.json";
...
describe("Create a page without error - Metadata sucessfully", () => {
  ...
  for (let row in pages) {
    it("Create a page draf", () => {
      ...
      cy.xpath('/html/body/div[4]/div/div/div/div/div/div/div/div[1]/div[2]/form/div[4]/textarea').type(
        ...
        cy.xpath('/html/body/div[4]/div[1]/div/div/div/div/div[1]/div/div[1]/div[2]/form/ul/li[1]').click()
        //cy.xpath('/html/body/div[4]/div[1]/div/div/div/div/div[1]/div/div[1]/div[2]/form/ul/li[1]/button/span').click()
        cy.wait(2000);
        cy.xpath('/html/body/div[4]/div/div/div/div/div/div/div/div[2]/div/div[2]/form/div[1]/input').click({force: true})
        cy.xpath('/html/body/div[4]/div/div/div/div/div/div/div/div[2]/div/div[2]/form/div[1]/input').type(
          pages[row].metadata
          );
        cy.wait(2000);
    });
